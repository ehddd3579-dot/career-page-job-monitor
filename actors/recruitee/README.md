...
**Pull live job openings straight from any Recruitee careers site via the official public API. Give it company subdomains, get every role with title, department, location and apply link. No proxy, no API key.**
...
```json
{
  "boards": ["ibexa", "https://enseradesign.recruitee.com"],
...
The board token is **the subdomain in <company>.recruitee.com**. You can paste the full careers URL instead
