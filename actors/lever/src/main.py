...
MISS_HINT = (
    "No Lever board answered for this entry. The company may be on a platform "
    ...
    "sits on is enough. The token is the company slug in jobs.lever.co/<company>."
)
            ...
            async def handle(entry) -> None:
                ...
                if error:
                    ...
                    await Actor.push_data({
                        "recordType": "notFound",
                        "companyName": token,
                        "title": "Not found on Lever - see the hint column",
                        "boardToken": token,
                        "ats": ATS,
                        "error": error,
                        "hint": MISS_HINT,
